...
window.IA_STATE_SPINE = {
  ...
  nodes: [
    ...
    { id: 'q-thisspine', group: 'question', label: 'interactive IA spine (this surface)', state: 'proposed',
      evidence: 'Proposed; not yet merged. Flips to earned-as-artifact only when this PR merges.',
      pointer: 'docs/diagrams/interactive/ (this PR)' },
